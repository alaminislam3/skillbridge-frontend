...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-20 bg-white text-black overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-14 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
          ...
          <span className="text-lg font-semibold tracking-tight text-slate-900">
            ...
            <p className="text-sm text-black leading-relaxed max-w-xs">
              Connect with world-class tutors and unlock your potential. Learn
              anything, at your own pace, from experts who care.
            </p>
            {/* Social icons */}
            <div className="flex items-center gap-3 pt-1">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-8 h-8 rounded-md bg-white/5 border border-white/10 flex items-center justify-center text-black hover:text-white hover:bg-blue-600 hover:border-blue-600 transition-all duration-200"
                >
                  {icon}
                </a>
              ))}
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={label}>
                  <Link
                    href={href}
                    className="text-sm text-black hover:text-white transition-colors duration-150 flex items-center gap-1.5 group"
                  >
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                { label: "Become a Tutor", href: "/tutor/apply" },
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-600">
            © {currentYear} SkillBridge Technologies, Inc. All rights reserved.
          </p>
